...
<div class="container-fluid">
    ...
    <div id="contenido-pdf" class="bg-gray-100 p-4 rounded">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 border-t-4 border-blue-500">
                ...
                <div class="grid grid-cols-2 gap-4 text-center">
                    ...
                    <div class="bg-gray-50 p-3 rounded">
                        ...
                        <p class="text-xl font-bold text-gray-700">
                            ${{ number_format($data[count($data) - 2], 2) }}
                        </p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 border-t-4 border-purple-500">
                ...
                <div class="mt-4">
                    ...
                    <ul class="list-disc list-inside text-sm text-gray-700 space-y-1">
                        <li>
                            Tendencia detectada:
                            <strong>{{ $prediccion['tendencia'] }}</strong>
                        </li>

                        <li>
                            Estabilidad de datos:
                            <strong>{{ count($labels) > 6 ? 'Alta' : 'Baja' }}</strong>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 border-t-4 border-indigo-500">
                ...
                <div class="text-center py-6 bg-indigo-50 rounded-lg mb-4">
                    <p class="text-sm text-indigo-600 uppercase tracking-wide">
                        Proyección Mes {{ $prediccion['mes_predicho'] }}
                    </p>

                    <p class="text-4xl font-extrabold text-indigo-900 mt-2">
                        ${{ number_format($prediccion['venta_estimada'], 2) }}
                    </p>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 border-t-4 {{ $colorClase }}">
                <div class="flex items-center justify-between mb-2">
                    <h3 class="text-xl font-bold text-gray-800">
                        4. Analítica Prescriptiva
                    </h3>

                    <span class="{{ $badgeClase }} text-gray-800 text-xs font-semibold px-2.5 py-0.5 rounded">
                        Recomendación IA
                    </span>
                </div>
                ...
                <div class="space-y-3">
                    @foreach($prescripcion as $tipo => $accion)
