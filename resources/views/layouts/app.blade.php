...
<div class="sidebar">
    ...
    <div class="sidebar-header text-center">
        <a href="{{ route('dashboard') }}">
            <img src="{{ asset('MineData.jpg') }}" alt="Logo" class="img-fluid p-1 bg-white rounded" style="max-height: 50px;">
        </a>
    </div>
...
<a href="{{ route('linear.index') }}"
   class="{{ request()->routeIs('linear.*') ? 'active' : '' }}">
    <i class="bi bi-graph-up-arrow me-2"></i>
    Regresión Lineal
</a>

<a href="{{ route('kdd.index') }}"
   class="{{ request()->routeIs('kdd.index') ? 'active' : '' }}">
    <i class="bi bi-diagram-3-fill me-2"></i>
    KDD
</a>

<a href="{{ route('randomforest.index') }}"
   class="{{ request()->routeIs('randomforest.index') ? 'active' : '' }}">
    <i class="bi bi-diagram-3-fill me-2"></i>
    Random Forest
</a>

<a href="{{ route('neural.index') }}"
   class="{{ request()->routeIs('neural.index') ? 'active' : '' }}">
    <i class="bi bi-diagram-3-fill me-2"></i>
    Neuronal
</a>
...
<a href="{{ route('datos.index') }}"
   class="{{ request()->routeIs('datos.index') ? 'active' : '' }}">
