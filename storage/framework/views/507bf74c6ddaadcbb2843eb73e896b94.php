...
<div class="sidebar">
    ...
    <div class="sidebar-menu">
        ...
        <a href="<?php echo e(route('dashboard')); ?>" class="<?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>">
            <i class="bi bi-person-badge-fill me-2"></i> Panel de Control
        </a>
        
        <?php if(Auth::user()->hasRole(['gerente', 'dba'])): ?>
    <div class="menu-label">Algoritmos de datos</div>
    <a href="<?php echo e(route('pagos.index')); ?>" class="<?php echo e(request()->is('pagos*') ? 'active' : ''); ?>">
        <i class="bi bi-graph-up-arrow me-2"></i></i> Regresión Lineal
    </a>
    <a href="<?php echo e(route('empleados.index')); ?>" class="<?php echo e(request()->is('empleados*') ? 'active' : ''); ?>">
        <i class="bi bi-diagram-3-fill me-2"></i></i> KDD
    </a>
    <a href="<?php echo e(route('empleados.index')); ?>" class="<?php echo e(request()->is('empleados*') ? 'active' : ''); ?>">
        <i class="bi bi-diagram-3-fill me-2"></i></i> Random Forest
    </a>
    <a href="<?php echo e(route('empleados.index')); ?>" class="<?php echo e(request()->is('empleados*') ? 'active' : ''); ?>">
        <i class="bi bi-diagram-3-fill me-2"></i></i> Neuronal
    </a>
    <?php endif; ?>
...
<a href="<?php echo e(route('datos.index')); ?>"
   class="<?php echo e(request()->routeIs('datos.index') ? 'active' : ''); ?>">
    <i class="bi bi-database-fill me-2"></i>Cargar y ver datos
</a>
        <?php endif; ?>

        <?php if(Auth::user()->hasRole(['vendedor', 'gerente', 'dba'])): ?>
            <div class="menu-label">Reportes</div>
            <a href="<?php echo e(route('clientes.index')); ?>" class="<?php echo e(request()->is('clientes*') ? 'active' : ''); ?>">
                <i class="bi bi-person-vcard me-2"></i> Generar Reporte
            </a>
             <?php endif; ?>
    ...
    <div class="sidebar-footer">
        <div class="text-white small mb-2 text-center bg-dark p-2 rounded">
            Hola, <strong><?php echo e(Auth::user()->name); ?></strong> <br>
            <span class="text-info badge bg-dark border border-info mt-1">
                <?php echo e(ucfirst(Auth::user()->role->nombre ?? 'Sin Rol')); ?>
...
</html><?php /**PATH C:\Users\Cerea\Documents\Tareas\Septimo Semestre\mineria de datos\ProyectoFinal\opticsSight\resources\views/layouts/app.blade.php ENDPATH**/ ?>